...
2. Initialize the memory with proper memory locations for first number, second number, result in r0, r3 adn r5 registers respectively.
...
The files addition_lookup.py is the utility code togenerate addition_lookup.txt for  reference. The lookup data is used seperately in the addition.py file as part of the input program loaded.